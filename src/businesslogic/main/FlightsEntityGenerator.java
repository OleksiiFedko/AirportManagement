...
public class FlightsEntityGenerator {
    ...
    /* Этот комент удали, это рабочий комент для меня, что бы не сворачиваться, а видеть необходимые поля.
    * idFlight, FlightNumber+, DepartureCity+, DepartureTime, ArrivalCity+, ArrivalTime, Gate+, Terminal+, FlightStatus+, ClassType+, Price;
    *
    * */

    // В flightStatusGenerator НАДО ВПИСАТЬ СТАТУСЫ ПОЛЁТОВ В SWITCH!!!!!
    // на время прибытия и отбытия, и на цену я классы не сделал.
